    ...
    if (BACTERIUM.COLOR_BY_INHERITANCE) {
        ...
        switch (phenotype) {
            ...
            case 'switch':
                ...
                break;
            case "continuous":
                const red = cytoplasmConcentrations.r/1.5;
                const green = cytoplasmConcentrations.p/1.5
                const blue =  cytoplasmConcentrations.r/1.5 +cytoplasmConcentrations.p/1.5;
