...
export const setExtraParameter = (paramName, value) => {parameters.ext[paramName].val = value;};


export const setIntraParameter = (paramName, value) => {parameters.int[paramName].val = value;};
